...
ChatGPTに貼り付けるだけで、オリジナルLINEスタンプ32枚分（4×4シート×2枚）のプロンプトが自動生成できる静的Webアプリです。
...
3. ボタンを押すと「ChatGPTに貼り付けるプロンプト」が32枚分まとめて生成される
...
### ステップ4：仕上げてLINEに申請する
1. 32枚の中から好きなものを選ぶ（LINE公式の枚数範囲：8〜40枚）
